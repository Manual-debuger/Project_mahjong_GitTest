...
#nullable disable
    ...
    {
        _inGameUIController.ShowActionHint(CastAPIIndexToLocalIndex(e.Index), "吃");
    ...
    {
        _inGameUIController.ShowActionHint(CastAPIIndexToLocalIndex(e.Index), "碰");
    ...
    {
        _inGameUIController.ShowActionHint(CastAPIIndexToLocalIndex(e.Index), "槓");
